...
class AkuLakuScreen extends StatefulWidget {
  const AkuLakuScreen({
    Key? key,
  ...
  @override
  State<AkuLakuScreen> createState() => _AkuLakuScreenState();
}

class _AkuLakuScreenState extends State<AkuLakuScreen> {
  late String accountNo;
  late String accountName;
  late String accountEmail;
  late String accountPhone;
  late String tIspId;

  late final _ccFuture = Provider.of<QrisProv>(
    context,
    listen: false,
  ).generateAkuLakuPayment(
    accountNo: accountNo,
  ...
  void initState() {
    ...
    accountPhone = customerData.accountHp;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: GradientAppBar(title: 'Pembayaran Akulaku'),
      body: FutureBuilder(
        future: _ccFuture,
        builder: (ctx, dataSnapshot) {
          ...
          return Consumer<QrisProv>(builder: (ctx, akulakuData, _) {
            final cc = akulakuData.akuLakuPayment!;
            return SafeArea(
              child: Stack(
                children: [
                  InAppWebView(
